  ...
  [1],
  {
    522: function(e, t, n) {
      ...
      var r = (function() {
        ...
        s = _interopRequireDefault(n(157)),
        l = n(524);
    ...
    523: function(e, t, n) {
      e.exports = (function() {
              ...
              if (i.test(p[z])) {
                ...
                for (var j = V; j < z; )
                  if (a.test(p[j])) {
                    ...
                    B.splice(U, 0, new BidiSpan(2, _, j)), (V = j);
                  } else ++j;
        ...
        function endOperation(e) {
          ...
          !(function finishOperation(e, t) {
            ...
            !(function endOperations(e) {
              ...
              for (var o, i = 0; i < t.length; i++) endOperation_R2(t[i]);
                      ...
                      (function retreatFrontier(e, t) {
                        if (
                          ...
                          for (var n = e.first, r = t - 1; r > n; r--) {
                            ...
                            if (
                              o &&
                              (!(o instanceof ee) || r + o.lookAhead < t)
                            ) {
                              n = r + 1;
                              break;
                            }
        ...
        return (
          eventMixin(ke),
          (CodeMirror$1.inputStyles = { textarea: _e, contenteditable: je }),
                ...
                (t.tokenize = (function tokenString(e) {
                  return function(t, n) {
                    ...
                    for (; null != (r = t.next()) && (r != e || o); )
                      o = !o && "\\" == r;
                    return (
                      o || (n.tokenize = tokenBase), ret("string", "string")
                    );
                  };
                })(n)),
                t.tokenize(e, t)
