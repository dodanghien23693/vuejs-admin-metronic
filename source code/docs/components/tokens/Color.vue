...
.colors {
  ...
  grid-template-columns:
    calc(20% - #{$space-base}) calc(20% - #{$space-base}) calc(
      20% - #{$space-base}
    )
    calc(20% - #{$space-base})
    calc(20% - #{$space-base});
  ...
  @media (max-width: 1300px) {
    grid-template-columns:
      calc(25% - #{$space-base}) calc(25% - #{$space-base}) calc(
        25% - #{$space-base}
      )
      calc(25% - #{$space-base});
  }
  @media (max-width: 1100px) {
    grid-template-columns:
      calc(33.333% - #{$space-base}) calc(33.333% - #{$space-base})
      calc(33.333% - #{$space-base});
  }
