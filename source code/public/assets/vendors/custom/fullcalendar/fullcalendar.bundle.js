!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function s(t) {
        ...
        return (
          (n = a(n)),
          (e = { left: 0, right: 0, top: 0, bottom: (r = a(r)) }),
          !(function() {
            null === l &&
              ((t = i("<div><div/></div>")
                .css({
      ...
      (e.compensateScroll = function(t, e) {
        ...
        (e.distributeHeight = function(t, e, n) {
          ...
          o(t),
            ...
            n &&
              ((e -= d),
              (r = Math.floor(e / a.length)),
              (s = Math.floor(e - r * (a.length - 1)))),
      ...
      function p(t, e) {
        return t || e
          ? null == e
            ...
            : null == t
              ? 1
              : "string" === i.type(t) || "string" === i.type(e)
      ...
      (e.isPrimaryMouseButton = function(t) {
        ...
        (e.divideDurationByDuration = function(t, e) {
          ...
          return g(t) || g(e)
            ...
            : ((n = t.asMonths()),
              (r = e.asMonths()),
              Math.abs(n) >= 1 && w(n) && Math.abs(r) >= 1 && w(r)
                ? n / r
                : t.asDays() / e.asDays());
        }),
        (e.multiplyDuration = function(t, e) {
          ...
          return g(t)
            ...
            : ((n = t.asMonths()),
              Math.abs(n) >= 1 && w(n)
                ? r.duration({ months: n * e })
                : r.duration({ days: t.asDays() * e }));
        }),
        (e.durationHasTime = g),
          ...
          return (
            (t.invertRanges = function(e, n) {
              ...
              for (e.sort(s), r = 0; r < e.length; r++)
                (i = e[r]).startMs > a && o.push(new t(a, i.startMs)),
                  i.endMs > a && (a = i.endMs);
            ...
            (t.prototype.getStart = function() {
              return null != this.startMs
                ? i.default.utc(this.startMs).stripZone()
                : null;
            }),
            (t.prototype.getEnd = function() {
              return null != this.endMs
                ? i.default.utc(this.endMs).stripZone()
                : null;
            }),
    ...
    function(t, e, n) {
      ...
      function p(t, e, n) {
        ...
        return (
          r.isMoment(p) || o.isNativeDate(p) || void 0 === p
            ? (c = r.apply(null, t))
            : ((l = !1),
              (u = !1),
              h
                ? s.test(p)
                  ? ((t = [(p += "-01")]), (l = !0), (u = !0))
                  : (d = a.exec(p)) && ((l = !d[5]), (u = !0))
                : i.isArray(p) && (u = !0),
              (c = e || l ? r.utc.apply(r, t) : r.apply(null, t)),
              l
                ? ((c._ambigTime = !0), (c._ambigZone = !0))
                : n && (u ? (c._ambigZone = !0) : h && c.utcOffset(p))),
          (c._fullCalendar = !0),
          c
        );
      }
      (e.default = c),
        ...
        (l.time = function(t) {
          ...
          var e = 0;
          return (
            r.isDuration(t) && (e = 24 * Math.floor(t.asDays())),
          ...
          return (
            ...
            (t.prototype.sliceNormalRenderRanges = function(t) {
              ...
              for (e = 0; e < i.length; e++)
                (r = (n = i[e]).dateProfile.unzonedRange.intersect(t)) &&
    ...
    function(t, e, n) {
          ...
          return (
            ...
            (e.prototype.handleInteractionStart = function(e) {
              ...
              this.component.hitsNeeded(),
                ...
                e
                  ? ((o = r = { left: i.getEvX(e), top: i.getEvY(e) }),
                    s &&
                      ((n = i.getOuterRect(s)), (o = i.constrainPoint(o, n))),
                    (this.origHit = this.queryHit(o.left, o.top)),
                    s &&
                      this.options.subjectCenter &&
                      (this.origHit &&
                        (n = i.intersectRects(this.origHit, n) || n),
                      (o = i.getRectCenter(n))),
                    (this.coordAdjust = i.diffPoints(o, r)))
      ...
      function s(t, e) {
        return (
          (!t && !e) ||
          (!(!t || !e) && (t.component === e.component && a(t, e) && a(e, t)))
        );
      }
      function a(t, e) {
        for (var n in t)
            ...
            (t.createFromRawProps = function(e, n, a) {
              ...
              return (
                (u = i.default.parse(h, p.source)) &&
                  (d = s.default.createFromDiff(e.dateProfile, u, a)),
                f.id !== p.id && (y = f.id),
        ...
        p = (function(t) {
          ...
          return (
            ...
            (e.prototype.reportEventDrop = function(t, e, n, r) {
              var i = this.calendar.eventManager.mutateEventsWithId(
                  t.def.id,
                  e
                ),
                s = e.dateMutation;
    ...
    function(t, e, n) {
      ...
      (r.newMomentProto.format = function() {
        return this._fullCalendar && arguments[0]
          ? c(this, arguments[0])
          : this._ambigTime
            ? r.oldMomentFormat(i(this), "YYYY-MM-DD")
            : this._ambigZone
              ? r.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss")
              : this._fullCalendar
                ? r.oldMomentFormat(i(this))
                : r.oldMomentProto.format.apply(this, arguments);
      }),
        (r.newMomentProto.toISOString = function() {
          return this._ambigTime
            ...
            : this._ambigZone
              ? r.oldMomentFormat(i(this), "YYYY-MM-DD[T]HH:mm:ss")
              : this._fullCalendar
                ? r.oldMomentProto.toISOString.apply(i(this), arguments)
                : r.oldMomentProto.toISOString.apply(this, arguments);
        });
      var o = "\v",
        s = "",
        a = "",
      ...
      (e.formatDate = c),
        (e.formatRange = function(t, e, n, i, o) {
          return (
            (t = r.default.parseZone(t)),
            (e = r.default.parseZone(e)),
            (function(t, e, n, r, i) {
              var o,
                s,
                a,
              ...
              h((n = t.localeData().longDateFormat(n) || n)),
              t,
              e,
              i || " - ",
              o
          ...
          (p[t] = (function(t) {
            ...
            return {
              ...
              sameUnits: (function t(e) {
                ...
                for (r = 0; r < e.length; r++)
                  (i = e[r]).token
                    ? ((o = d[i.token.charAt(0)]),
                      n.push(o ? o.unit : "second"))
                    : i.maybe
                      ? n.push.apply(n, t(i.maybe))
                      : n.push(null);
                return n;
              })(e)
            };
            ...
            (e.prototype.limitRow = function(t, e) {
              ...
              if (e && e < b.segLevels.length) {
                for (
                  ...
                  if (u) {
                    for (
                      p = (c = r[e - 1][a.leftCol]).attr("rowspan") || 1,
                        h = [],
                        f = 0;
                      f < d.length;
                      f++
        ...
        d = (function(t) {
          ...
          return (
                  ...
                  (e.prototype.renderHeadIntroHtml = function() {
                    ...
                    return this.colWeekNumbersVisible
                      ? '<th class="fc-week-number ' +
                          ...
                          "><span>" +
                          o.htmlEscape(this.opt("weekNumberTitle")) +
                          "</span></th>"
                      : "";
                  }),
                  (e.prototype.renderNumberIntroHtml = function(t) {
              ...
              this.dayGrid.rowEls
                ? (t.prototype.updateSize.call(this, e, n, r),
                  this.dayGrid.colWeekNumbersVisible &&
                    (this.weekNumberWidth = o.matchCellWidths(
                      this.el.find(".fc-week-number")
                    )),
                  this.scroller.clear(),
                  o.uncompensateScroll(l),
            ...
            (e.prototype.setGridHeight = function(t, e) {
              e
                ? o.undistributeHeight(this.dayGrid.rowEls)
                : o.distributeHeight(this.dayGrid.rowEls, t, !0);
            }),
            (e.prototype.computeInitialDateScroll = function() {
              return { top: 0 };
            }),
          ...
          return (
            ...
            (t.prototype.isEventInstanceGroupAllowed = function(t) {
              var e,
                ...
                i = this.getPeerEventInstances(n).map(
            ...
            (t.prototype.isFootprintAllowed = function(t, e, n, r, i) {
              ...
              if (((s = this.collectOverlapEventFootprints(e, t)), !1 === r)) {
                ...
                !(function(t, e, n) {
                  ...
                  for (r = 0; r < t.length; r++)
                    if (
                      !e(t[r].eventInstance.toLegacy(), n ? n.toLegacy() : null)
                    )
                      return !1;
                  return !0;
                })(s, r, i)
              ...
              return (
                t.start &&
                  ((e = this._calendar.moment(t.start)).isValid() ||
                    (e = null)),
                t.end &&
                  ((n = this._calendar.moment(t.end)).isValid() || (n = null)),
                [
                  new i.default(
                    new r.default(e, n),
        ...
        c = (function(t) {
          ...
          return (
            ...
            (e.prototype.buildGotoAnchorHtml = function(t, e, n) {
              ...
              return (
                i.isPlainObject(t)
                  ? ((r = t.date), (o = t.type), (l = t.forceOff))
                  : (r = t),
                (u = {
              ...
              e.addClass("fc"),
                e.on("click.fc", "a[data-goto]", function(e) {
                  var n = r(e.currentTarget).data("goto"),
                    ...
                    s = n.type,
                    a = t.view.opt(
                      "navLink" + o.capitaliseFirstLetter(s) + "Click"
                    );
                  "function" == typeof a
                    ? a(i, e)
                    : ("string" == typeof a && (s = a), t.zoomTo(i, s));
                }),
                this.optionsManager.watch(
                  "settingTheme",
                  ["?theme", "?themeSystem"],
                  function(n) {
                    var r = new (M.getThemeSystemClass(
                ...
                this.opt("handleWindowResize") &&
                  r(window).resize(
                    (this.windowResizeProxy = o.debounce(
                ...
                this.optionsManager.watch(
                  ...
                  function(e) {
                    ...
                    e.monthNames && (o._months = e.monthNames),
                      ...
                      null == i && "ISO" === r && (i = 1),
                      null != i &&
                        (((n = Object.create(o._week)).dow = i), (o._week = n)),
                      ("ISO" !== r &&
                        "local" !== r &&
                        "function" != typeof r) ||
            ...
            (t.prototype.moment = function() {
              ...
              return (
                "local" === this.opt("timezone")
                  ? (t = v.default.apply(null, e)).hasTime() && t.local()
                  : (t =
                      "UTC" === this.opt("timezone")
                        ? v.default.utc.apply(null, e)
                        : v.default.parseZone.apply(null, e)),
        ...
        s = (function() {
          ...
          return (
            ...
            (t.prototype.build = function(t, e, n) {
              ...
              return (
                ...
                (u = this.buildRenderRange(
                  this.trimHiddenDays(a.unzonedRange),
                  a.unit,
                  l
                )),
                (d = (u = this.trimHiddenDays(u)).clone()),
                this.opt("showNonCurrentDates") ||
                  (d = d.intersect(a.unzonedRange)),
                (o = r.duration(this.opt("minTime"))),
                (s = r.duration(this.opt("maxTime"))),
                (d = (d = this.adjustActiveRange(d, o, s)).intersect(i)) &&
                  (t = this.msToUtcMoment(d.constrainDate(t), p)),
            ...
            (t.prototype.buildRangeFromDuration = function(t, e, n, s) {
              ...
              return (
                p ||
                  ((a = this.opt("dateIncrement"))
                    ? ((l = r.duration(a)),
                      (p = l < n ? i.computeDurationGreatestUnit(l, a) : s))
                    : (p = s)),
                n.as("days") <= 1 &&
                ...
                this.trimHiddenDays(c) ||
                  ((t = this._view.skipHiddenDays(t, e)), h()),
                c
              );
            }),
        ...
        f = (function(t) {
          ...
          return (
            ...
            (e.prototype.handleDragStart = function(t, e) {
              var n, r;
              this.opt("droppable") &&
                ((n = i((e ? e.item : null) || t.target)),
                (r = this.opt("dropAccept")),
                (i.isFunction(r) ? r.call(n[0], n) : n.is(r)) &&
            ...
            (e.prototype.listenToExternalDrag = function(t, e, n) {
              var r,
                ...
                h = (function(t) {
                  ...
                  return (
                    (n = null != n ? o.duration(n) : null),
                    (r = null != r ? o.duration(r) : null),
                    (a = Boolean(a)),
                    { eventProps: e, startTime: n, duration: r, stick: a }
                  );
                })(t);
              (this.dragListener = new d.default(u, {
                ...
                hitOver: function(t) {
                  ...
                  i && (r = l.computeExternalDrop(i, h))
                    ? ((e = new p.default(r.buildInstances())),
                      (n = h.eventProps
                        ? u.isEventInstanceGroupAllowed(e)
                        : u.isExternalInstanceGroupAllowed(e)))
                    : (n = !1),
            ...
            (e.prototype.computeExternalDrop = function(t, e) {
              ...
              return (
                ...
                c.default.parse(
                  i.extend({}, e.eventProps, { start: o, end: n }),
                  new h.default(r)
                )
              );
            }),
          ...
          return (
            ...
            (e.prototype.computeEventStartResizeMutation = function(t, e, n) {
              ...
              return (
                ...
                ((r = new a.default()).setStartDelta(l),
                (i = new s.default()).setDateMutation(r),
                i)
              );
            }),
        ...
        h = (function(t) {
          ...
          return (
            ...
            (e.prototype.updateSize = function(e, n, r) {
              ...
              if (
                (t.prototype.updateSize.call(this, e, n, r),
                (this.axisWidth = l.matchCellWidths(this.el.find(".fc-axis"))),
        ...
        u = (function() {
          ...
          return (
            ...
            (t.prototype.buildViewSpec = function(t) {
              ...
              return (
                ((e = s.mergeProps(c)).type = t),
                !!e.class &&
                  ((i =
                    i ||
                    this.optionsManager.dynamicOverrides.duration ||
                    this.optionsManager.overrides.duration) &&
                    (l = r.duration(i)).valueOf() &&
          ...
          return (
            ...
            (t.prototype.buildMutatedEventInstanceGroup = function(t, e) {
              ...
              for (n = 0; n < i.length; n++)
                (r = i[n].clone()) instanceof u.default &&
          ...
          return (
            ...
            (e.prototype.fgSegHtml = function(t, e) {
              ...
              if (
                ...
                s.isMultiDayRange(l.unzonedRange))
              ) {
              ...
              return (
                ...
                (n
                  ...
                  : "") +
                (d.title
                  ? '<div class="fc-title">' + i.htmlEscape(d.title) + "</div>"
                  : "") +
                '</div><div class="fc-bg"/>' +
          ...
          return (
              ...
              for (n = 0; n < p; n++) {
                if (
                  ...
                  for (a = 0; a < r.length; a++) {
                    for (
                      y((l = r[a]).leftCol),
                        u = i('<td class="fc-event-container"/>').append(l.el),
            ...
            (e.prototype.fgSegHtml = function(t, e) {
              ...
              return (
                ...
                t.isStart &&
                  (n = this.getTimeText(t.footprint)) &&
                  (h = '<span class="fc-time">' + o.htmlEscape(n) + "</span>"),
                (r =
                  '<span class="fc-title">' +
                  (o.htmlEscape(s.title || "") || "&nbsp;") +
                  "</span>"),
                '<a class="' +
                  c.join(" ") +
                  '"' +
                  (s.url ? ' href="' + o.htmlEscape(s.url) + '"' : "") +
                  (p ? ' style="' + p + '"' : "") +
                  '><div class="fc-content">' +
  ...
  (function(t, e) {
    "object" == typeof exports && "object" == typeof module
      ? (module.exports = e(require("fullcalendar"), require("jquery")))
      : "function" == typeof define && define.amd
        ? define(["fullcalendar", "jquery"], e)
        : "object" == typeof exports
          ? e(require("fullcalendar"), require("jquery"))
          : e(t.FullCalendar, t.jQuery);
  })("undefined" != typeof self ? self : this, function(t, e) {
    return (function(t) {
      var e = {};
      function n(r) {
          ...
          s = (function(t) {
            ...
            return (
              ...
              (e.prototype.fetch = function(t, e, n) {
                ...
                return a
                  ? (this.calendar.pushLoading(),
                    o.Promise.construct(function(t, e) {
                      i.ajax(
                        i.extend({}, o.JsonFeedEventSource.AJAX_DEFAULTS, l, {
                          url: s,
                          data: a,
                          success: function(n, s, l) {
                            ...
                            r.calendar.popLoading(),
                              n.error
                                ? (r.reportError(
                                    "Google Calendar API: " + n.error.message,
                                    n.error.errors
                                  ),
                                  e())
                                : n.items &&
                                  ((d = r.gcalItemsToRawEventDefs(
                                    n.items,
                                    a.timeZone
                                  )),
                                  (c = o.applyAll(u, r, [n, s, l])),
                                  i.isArray(c) && (d = c),
                                  t(r.parseEventDefs(d)));
                          },
                          error: function(t, n, i) {
                            r.reportError(
                              "Google Calendar network failure: " + n,
                              [t, i]
                            ),
                              r.calendar.popLoading(),
                              e();
                  ...
                  ? (t.hasZone() ||
                    ...
                    e.hasZone() ||
                      (e = e
                        ...
                        .utc()
                        .add(1, "day")),
                    (r = i.extend(this.ajaxSettings.data || {}, {
                      key: o,
                      timeMin: t.format(),
                      timeMax: e.format(),
                      singleEvents: !0,
              ...
              (e.prototype.reportError = function(t, e) {
                ...
                this.googleCalendarError &&
                  this.googleCalendarError.apply(n, i),
                  r && r.apply(n, i),
              ...
              (e.prototype.applyManualStandardProps = function(t) {
                var e = o.EventSource.prototype.applyManualStandardProps.apply(
                    this,
                    arguments
                  ),
                  ...
                  null == n &&
                    ...
                    (n = (function(t) {
                      ...
                      if (
                        ...
                        return t;
                      if (
                        (e = /^https:\/\/www.googleapis.com\/calendar\/v3\/calendars\/([^\/]*)/.exec(
                          t
                        )) ||
                        (e = /^https?:\/\/www.google.com\/calendar\/feeds\/([^\/]*)/.exec(
                          t
                        ))
                      )
