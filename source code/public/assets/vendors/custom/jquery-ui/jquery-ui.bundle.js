          ...
          flip: {
            ...
            top: function(t, e) {
              ...
              0 > c
                ...
                : u > 0 &&
                  (((i =
                    t.top - e.collisionPosition.marginTop + d + p + f - h) >
                    0 ||
                    u > o(i)) &&
                    (t.top += d + p + f));
            }
    ...
    (t.ui.focusable = function(e, i) {
      ...
      return "area" === h
        ...
        : (/^(input|select|textarea|button|object)$/.test(h)
            ? (a = !e.disabled) &&
              ((r = t(e).closest("fieldset")[0]) && (a = !r.disabled))
            : (a = ("a" === h && e.href) || i),
          a &&
            t(e).is(":visible") &&
            (function(t) {
      ...
      return this[0].labels && this[0].labels.length
        ...
        : ((n = this.eq(0).parents("label")),
          (s = this.attr("id")) &&
            ((o = (e = this.eq(0)
              .parents()
              .last()).add(e.length ? e.siblings() : this.siblings())),
        ...
        t.each(
          ...
          function() {
            this.options &&
              (!this.options.disabled &&
                this.visible &&
                l(e, this, this.options.tolerance, i) &&
        ...
        t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
          if (!this.options.disabled && !this.greedyChild && this.visible) {
            var s,
              n,
              o,
              a = l(e, this, this.options.tolerance, i),
              r =
                !a && this.isover
                  ? "isout"
                  : a && !this.isover
  ...
  t.widget("ui.controlgroup", {
    ...
    t.widget("ui.slider", t.ui.mouse, {
      ...
      values: function(e, i) {
        ...
        for (s = this.options.values, n = e, o = 0; s.length > o; o += 1)
    ...
    t.widget("ui.tabs", {
      ...
      _initialActive: function() {
        ...
        return (
          ...
          !1 !== e &&
            (-1 === (e = this.tabs.index(this.tabs.eq(e))) && (e = !i && 0)),
      ...
      function i(e) {
        return (
          ...
          (("string" == typeof e && !t.effects.effect[e]) ||
            (!!t.isFunction(e) || ("object" == typeof e && !e.effect)))
        );
      }
      function s(t, e) {
        var i = e.outerWidth(),
