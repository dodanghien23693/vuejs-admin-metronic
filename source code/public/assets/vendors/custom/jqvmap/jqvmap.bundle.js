var VectorCanvas = function(l, a, t) {
  if (
...
var ColorScale = function(l, a, t, e) {
  l && this.setColors(l),
    a && this.setNormalizeFunction(a),
    t && this.setMin(t),
    t && this.setMax(e);
};
...
var JQVMap = function(l) {
  ...
  for (var s in ((this.selectedRegions = []),
  ...
  jQuery(window).resize(function() {
    var e = l.container.width(),
      s = l.container.height();
    if (e && s) {
      (t.width = e),
        (t.height = s),
        t.resize(),
        t.canvas.setSize(t.width, t.height),
        t.applyTransform();
      var c = jQuery.Event("resize.jqvmap");
      jQuery(l.container).trigger(c, [e, s]),
        a &&
          (jQuery(".jqvmap-pin").remove(),
          (t.pinHandlers = !1),
          t.placePins(a.pins, a.mode));
    }
  }),
  ...
  (t.countries = []),
  e.paths)) {
    var c = this.canvas.createPath({ path: e.paths[s].path });
    c.setFill(this.color),
      (c.id = t.getCountryId(s)),
      (t.countries[s] = c),
      "svg" === this.canvas.mode
        ? c.setAttribute("class", "jqvmap-region")
        : jQuery(c).addClass("jqvmap-region"),
      jQuery(this.rootGroup).append(c);
  }
  if (
    (jQuery(l.container).delegate(
      ...
      function(a) {
        var s = a.target,
          c = a.target.id.split("_").pop(),
          n = jQuery.Event("labelShow.jqvmap"),
          h = jQuery.Event("regionMouseOver.jqvmap");
        (c = c.toLowerCase()),
          "mouseover" === a.type
            ? (jQuery(l.container).trigger(h, [c, e.paths[c].name]),
              h.isDefaultPrevented() || t.highlight(c, s),
              l.showTooltip &&
                (t.label.text(e.paths[c].name),
                jQuery(l.container).trigger(n, [t.label, c]),
                n.isDefaultPrevented() ||
                  (t.label.show(),
                  (t.labelWidth = t.label.width()),
                  (t.labelHeight = t.label.height()))))
            : (t.unhighlight(c, s),
              t.label.hide(),
    ...
    jQuery(l.container).delegate(
      ...
      function(a) {
        var s = a.target,
          c = a.target.id.split("_").pop(),
          n = jQuery.Event("regionClick.jqvmap");
        if (
          ((c = c.toLowerCase()),
          jQuery(l.container).trigger(n, [c, e.paths[c].name]),
          !l.multiSelectRegion && !n.isDefaultPrevented())
        )
          for (var h in e.paths)
            (t.countries[h].currentFillColor = t.countries[
              h
            ].getOriginalFill()),
              t.countries[h].setFill(t.countries[h].getOriginalFill());
        n.isDefaultPrevented() ||
          (t.isSelected(c) ? t.deselect(c, s) : t.select(c, s));
      }
    ),
    l.showTooltip &&
      l.container.mousemove(function(l) {
        if (t.label.is(":visible")) {
          var a = l.pageX - 15 - t.labelWidth,
            e = l.pageY - 15 - t.labelHeight;
          a < 0 && (a = l.pageX + 15),
            e < 0 && (e = l.pageY + 15),
            t.label.css({ left: a, top: e });
        }
      }),
    ...
    if (l.selectedRegions instanceof Array)
      for (var n in l.selectedRegions)
        this.select(l.selectedRegions[n].toLowerCase());
    else this.select(l.selectedRegions.toLowerCase());
  if (
    (this.bindZoomButtons(),
    l.pins &&
      ((a = { pins: l.pins, mode: l.pinMode }),
      (this.pinHandlers = !1),
    ...
    this.pinHandlers = !1;
    var h = {};
    for (s in t.countries)
      "function" != typeof t.countries[s] &&
        ((l.pins && l.pins[s]) || (h[s] = s.toUpperCase()));
    (a = { pins: h, mode: "content" }), this.placePins(h, "content");
  }
  JQVMap.mapIndex++;
};
(JQVMap.prototype = {
  ...
  (function() {
    ...
    jQuery.fn.vectorMap = function(t) {
      ...
      if ("addMap" === t) JQVMap.maps[arguments[1]] = arguments[2];
      else {
        if ("set" !== t || !l[arguments[1]]) {
          if ("string" == typeof t && "function" == typeof s[t])
            return s[t].apply(s, Array.prototype.slice.call(arguments, 1));
          for (var c in (jQuery.extend(e, t),
          (e.container = this),
          ...
          this.unbind(".jqvmap"),
          a))
            e[c] && this.bind(a[c] + ".jqvmap", e[c]);
          var n = jQuery.Event("load.jqvmap");
          return jQuery(e.container).trigger(n, s), s;
        }
        s[
  ...
  (ColorScale.arrayToRgb = function(l) {
    for (var a, t = "#", e = 0; e < l.length; e++)
      t += 1 === (a = l[e].toString(16)).length ? "0" + a : a;
    return t;
  }),
  (ColorScale.prototype.getColor = function(l) {
    "function" == typeof this.normalize && (l = this.normalize(l));
    for (var a, t = [], e = 0, s = 0; s < this.colors.length - 1; s++)
      (a = this.vectorLength(
        ...
        (e += a);
    var c,
      n = (this.maxValue - this.minValue) / e;
    for (s = 0; s < t.length; s++) t[s] *= n;
    for (s = 0, l -= this.minValue; l - t[s] >= 0; ) (l -= t[s]), s++;
    for (
      c =
  ...
  (ColorScale.prototype.setColors = function(l) {
    for (var a = 0; a < l.length; a++) l[a] = ColorScale.rgbToArray(l[a]);
    this.colors = l;
  }),
  ...
  (ColorScale.prototype.vectorAdd = function(l, a) {
    for (var t = [], e = 0; e < l.length; e++) t[e] = l[e] + a[e];
    return t;
  }),
  (ColorScale.prototype.vectorLength = function(l) {
    for (var a = 0, t = 0; t < l.length; t++) a += l[t] * l[t];
    return Math.sqrt(a);
  }),
  (ColorScale.prototype.vectorMult = function(l, a) {
    for (var t = [], e = 0; e < l.length; e++) t[e] = l[e] * a;
    return t;
  }),
  (ColorScale.prototype.vectorSubtract = function(l, a) {
    for (var t = [], e = 0; e < l.length; e++) t[e] = l[e] - a[e];
    return t;
  }),
  (ColorScale.prototype.vectorToNum = function(l) {
    for (var a = 0, t = 0; t < l.length; t++)
      a += Math.round(l[t]) * Math.pow(256, l.length - t - 1);
    return a;
  }),
      ...
      this.defaultHeight * this.scale <= this.height
        ? ((a =
          ...
          (e =
            (this.height - this.defaultHeight * this.scale) / (2 * this.scale)))
        : ((a = 0),
          (e = (this.height - this.defaultHeight * this.scale) / this.scale)),
      this.transY > a
        ? (this.transY = a)
  ...
  (JQVMap.prototype.deselect = function(l, a) {
    if (
      ((l = l.toLowerCase()),
      (a = a || jQuery("#" + this.getCountryId(l))[0]),
      this.isSelected(l))
    )
      this.selectedRegions.splice(this.selectIndex(l), 1),
        jQuery(this.container).trigger("regionDeselect.jqvmap", [l]),
        (a.currentFillColor = a.getOriginalFill()),
        a.setFill(a.getOriginalFill());
    else
  ...
  (JQVMap.prototype.highlight = function(l, a) {
    (a = a || jQuery("#" + this.getCountryId(l))[0]),
      this.hoverOpacity
        ? a.setOpacity(this.hoverOpacity)
        : this.hoverColors && l in this.hoverColors
          ? ((a.currentFillColor = a.getFill() + ""),
            a.setFill(this.hoverColors[l]))
          : this.hoverColor &&
            ((a.currentFillColor = a.getFill() + ""),
            a.setFill(this.hoverColor));
  }),
    ...
    (r.isMoving = !1),
      ...
      this.container
        .mousemove(function(t) {
          return (
            o &&
              ((r.transX -= (l - t.pageX) / r.scale),
              (r.transY -= (a - t.pageY) / r.scale),
              r.applyTransform(),
              (l = t.pageX),
              (a = t.pageY),
              (r.isMoving = !0),
              r.isMovingTimeout && clearTimeout(r.isMovingTimeout),
              r.container.trigger("drag")),
            !1
          );
        })
        .mousedown(function(t) {
          return (o = !0), (l = t.pageX), (a = t.pageY), !1;
        })
        .mouseup(function() {
          return (
            (o = !1),
      ...
      jQuery(this.container).bind("touchmove", function(l) {
        var a,
          ...
          m,
          p,
          L = l.originalEvent.touches;
        if (1 === L.length) {
          if (1 === t) {
            if (h === L[0].pageX && i === L[0].pageY) return;
            (m = r.transX),
              (p = r.transY),
              (r.transX -= (h - L[0].pageX) / r.scale),
              (r.transY -= (i - L[0].pageY) / r.scale),
              r.applyTransform(),
              (m === r.transX && p === r.transY) || l.preventDefault(),
              (r.isMoving = !0),
              r.isMovingTimeout && clearTimeout(r.isMovingTimeout);
          }
          (h = L[0].pageX), (i = L[0].pageY);
        } else 2 === L.length && (2 === t ? ((o = Math.sqrt(Math.pow(L[0].pageX - L[1].pageX, 2) + Math.pow(L[0].pageY - L[1].pageY, 2)) / c), r.setScale(n * o, e, s), l.preventDefault()) : ((a = jQuery(r.container).offset()), (e = L[0].pageX > L[1].pageX ? L[1].pageX + (L[0].pageX - L[1].pageX) / 2 : L[0].pageX + (L[1].pageX - L[0].pageX) / 2), (s = L[0].pageY > L[1].pageY ? L[1].pageY + (L[0].pageY - L[1].pageY) / 2 : L[0].pageY + (L[1].pageY - L[0].pageY) / 2), (e -= a.left), (s -= a.top), (n = r.scale), (c = Math.sqrt(Math.pow(L[0].pageX - L[1].pageX, 2) + Math.pow(L[0].pageY - L[1].pageY, 2)))));
        t = L.length;
      }),
  ...
  (JQVMap.prototype.placePins = function(l, a) {
    var t = this;
    if (
      ((!a || ("content" !== a && "id" !== a)) && (a = "content"),
      "content" === a
        ? jQuery.each(l, function(l, a) {
            if (0 !== jQuery("#" + t.getCountryId(l)).length) {
              var e = t.getPinId(l),
                s = jQuery("#" + e);
              s.length > 0 && s.remove(),
                t.container.append(
  ...
  (JQVMap.prototype.positionPins = function() {
    var l = this,
      a = this.container.find(".jqvmap-pin");
    jQuery.each(a, function(a, t) {
      t = jQuery(t);
      var e = l.getCountryId(t.attr("for").toLowerCase()),
        s = jQuery("#" + e),
        c = document.getElementById(e).getBBox(),
        n = s.position(),
        h = l.scale,
        i = n.left + (c.width / 2) * h - t.width() / 2,
        o = n.top + (c.height / 2) * h - t.height() / 2;
      t.css("left", i).css("top", o);
    });
  }),
  ...
  (JQVMap.prototype.select = function(l, a) {
    (l = l.toLowerCase()),
      (a = a || jQuery("#" + this.getCountryId(l))[0]),
      this.isSelected(l) ||
        ...
        this.selectedColor &&
          a &&
          ((a.currentFillColor = this.selectedColor),
          a.setFill(this.selectedColor)));
  }),
  (JQVMap.prototype.selectIndex = function(l) {
    l = l.toLowerCase();
    for (var a = 0; a < this.selectedRegions.length; a++)
      if (l === this.selectedRegions[a]) return a;
    return -1;
  }),
  (JQVMap.prototype.setBackgroundColor = function(l) {
    this.container.css("background-color", l);
  }),
  (JQVMap.prototype.setColors = function(l, a) {
    if ("string" == typeof l)
      this.countries[l].setFill(a),
        this.countries[l].setAttribute("original", a);
    else {
      var t = l;
      for (var e in t)
        this.countries[e] &&
          (this.countries[e].setFill(t[e]),
          this.countries[e].setAttribute("original", t[e]));
    }
  }),
  ...
  (JQVMap.prototype.setValues = function(l) {
    ...
    for (var s in l)
      (s = s.toLowerCase()),
        (a = parseFloat(l[s])),
        isNaN(a) || (a > t && (t = l[s]), a < e && (e = a));
    e === t && t++, this.colorScale.setMin(e), this.colorScale.setMax(t);
    var c = {};
    for (s in l)
      (s = s.toLowerCase()),
        (a = parseFloat(l[s])),
        (c[s] = isNaN(a) ? this.color : this.colorScale.getColor(a));
    this.setColors(c), (this.values = l);
  }),
  (JQVMap.prototype.unhighlight = function(l, a) {
    (l = l.toLowerCase()),
      (a = a || jQuery("#" + this.getCountryId(l))[0]).setOpacity(1),
      a.currentFillColor && a.setFill(a.currentFillColor);
  }),
  (JQVMap.prototype.zoomIn = function() {
    ...
    if (l.zoomCurStep < l.zoomMaxStep) {
      ...
      t.css("top", parseInt(t.css("top"), 10) - a),
  ...
  (VectorCanvas.prototype.applyTransformParams = function(l, a, t) {
    "svg" === this.mode
      ? this.rootGroup.setAttribute(
          "transform",
          "scale(" + l + ") translate(" + a + ", " + t + ")"
        )
  ...
  (VectorCanvas.prototype.createGroup = function(l) {
    ...
    return (
      "svg" === this.mode
        ? (a = this.createSvgNode("g"))
        : (((a = this.createVmlNode("group")).style.width = this.width + "px"),
  ...
  (VectorCanvas.prototype.createPath = function(l) {
    var a;
    if ("svg" === this.mode)
      (a = this.createSvgNode("path")).setAttribute("d", l.path),
        null !== this.params.borderColor &&
          a.setAttribute("stroke", this.params.borderColor),
        this.params.borderWidth > 0 &&
          (a.setAttribute("stroke-width", this.params.borderWidth),
          a.setAttribute("stroke-linecap", "round"),
          a.setAttribute("stroke-linejoin", "round")),
        this.params.borderOpacity > 0 &&
          a.setAttribute("stroke-opacity", this.params.borderOpacity),
        (a.setFill = function(l) {
        ...
        (a.setOpacity = function(l) {
          this.setAttribute("fill-opacity", l);
        });
    else {
      ((a = this.createVmlNode("shape")).coordorigin = "0 0"),
        (a.coordsize = this.width + " " + this.height),
        (a.style.width = this.width + "px"),
        (a.style.height = this.height + "px"),
        (a.fillcolor = JQVMap.defaultFillColor),
        (a.stroked = !1),
        (a.path = VectorCanvas.pathSvgToVml(l.path));
    ...
    return l
      .replace(/([MmLlHhVvCcSs])((?:-?(?:\d+)?(?:\.\d+)?,?\s?)+)/g, function(
        ...
        (h = h
          ...
          .replace(/\s+/g, ",")
          .split(","))[0] || h.shift();
        for (var i = 0, o = h.length; i < o; i++) h[i] = Math.round(100 * h[i]);
        switch (n) {
          case "m":
            (s += h[0]), (c += h[1]), (e = "t" + h.join(","));
            break;
          case "M":
            (s = h[0]), (c = h[1]), (e = "m" + h.join(","));
            break;
          case "l":
            (s += h[0]), (c += h[1]), (e = "r" + h.join(","));
            break;
          case "L":
            (s = h[0]), (c = h[1]), (e = "l" + h.join(","));
            break;
          case "h":
            (s += h[0]), (e = "r" + h[0] + ",0");
            break;
  ...
  (VectorCanvas.prototype.setSize = function(l, a) {
    if ("svg" === this.mode)
      ...
      for (
        ...
        (t[e].coordsize = l + " " + a),
          (t[e].style.width = l + "px"),
          (t[e].style.height = a + "px");
      (this.rootGroup.coordsize = l + " " + a),
        (this.rootGroup.style.width = l + "px"),
        (this.rootGroup.style.height = a + "px");
    }
