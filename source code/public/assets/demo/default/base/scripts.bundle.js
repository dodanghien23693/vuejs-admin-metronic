      ...
      if (0 !== t(this).length) {
        ...
        var o = {
          ...
          init: function(e) {
            var a = !1;
            return (
              null === e.data.source && (o.extractTable(), (a = !0)),
              o.setupBaseDOM.call(),
              o.setupDOM(n.table),
              o.spinnerCallback(!0),
              ...
              t(n).on("m-datatable--on-layout-updated", o.afterRender),
              n.debug && o.stateRemove(o.stateId),
              t.each(o.getOption("extensions"), function(e, a) {
                "function" == typeof t.fn.mDatatable[e] &&
                  new t.fn.mDatatable[e](n, a);
              }),
              ("remote" !== e.data.type && "local" !== e.data.type) ||
                ((!1 === e.data.saveState ||
                  (!1 === e.data.saveState.cookie &&
                    !1 === e.data.saveState.webstorage)) &&
                  o.stateRemove(o.stateId),
                "local" === e.data.type &&
                  "object" == typeof e.data.source &&
                  (n.dataSet = n.originalDataSet = o.dataMapCallback(
                    e.data.source
                  )),
                o.dataRender()),
              a ||
                (o.setHeadTitle(),
                o.getOption("layout.footer") && o.setHeadTitle(n.tableFoot)),
              ...
              (null !== e.data.type && "local" !== e.data.type) ||
                (o.setupCellField.call(),
                o.setupTemplateCell.call(),
                o.setupSubDatatable.call(),
                o.setupSystemColumn.call(),
                o.redraw()),
              t(window).resize(o.fullRender),
              t(n).height(""),
              t(o.getOption("search.input")).on("keyup", function(e) {
                (o.getOption("search.onEnter") && 13 !== e.which) ||
                  o.search(t(this).val());
              }),
              n
            );
          ...
          layoutUpdate: function() {
            o.setupSubDatatable.call(),
              o.setupSystemColumn.call(),
              o.setupHover.call(),
              void 0 === a.detail && 1 === o.getDepth() && o.lockTable.call(),
              o.columnHide.call(),
              o.resetScroll(),
              o.isInit ||
                (t(n).trigger("m-datatable--on-init", {
                  table: t(n.wrap).attr("id"),
                  options: a
                }),
                (o.isInit = !0)),
              t(n).trigger("m-datatable--on-layout-updated", {
                table: t(n.wrap).attr("id")
              });
          },
          lockTable: function() {
            var e = {
              lockEnabled: !1,
              init: function() {
                (e.lockEnabled = o.lockEnabledColumns()),
                      ...
                      t(this).ready(function() {
                        !(function(a) {
                          if (t(a).find(".m-datatable__lock").length > 0)
                            o.log("Locked container already exist in: ", a);
                          else if (
                            ...
                            t(a)
                              ...
                              e.lockEnabled.left.length > 0 &&
                                (t(n.wrap).addClass("m-datatable--lock"),
                                t(i).appendTo(a)),
                              (e.lockEnabled.left.length > 0 ||
          ...
          fullRender: function() {
            o.isLocked() &&
              (t(n.tableHead).empty(),
              o.setHeadTitle(),
              o.getOption("layout.footer") &&
                (t(n.tableFoot).empty(), o.setHeadTitle(n.tableFoot)),
              o.spinnerCallback(!0),
              t(n.wrap).removeClass("m-datatable--loaded"),
              o.insertData());
          },
          lockEnabledColumns: function() {
            ...
            return (
              t.each(o, function(t, a) {
                void 0 !== a.locked &&
                  (void 0 !== a.locked.left &&
                    e.getBreakpoint(a.locked.left) <= n &&
                    i.left.push(a.locked.left),
                  void 0 !== a.locked.right &&
                    e.getBreakpoint(a.locked.right) <= n &&
                    i.right.push(a.locked.right));
              }),
              i
            );
          },
          afterRender: function(e, a) {
            a.table == t(n.wrap).attr("id") &&
              t(n).ready(function() {
                o.isLocked() ||
                  (o.redraw(),
                  o.getOption("rows.autoHide") &&
                    (o.autoHide(),
                    t(n.table)
                      .find(".m-datatable__row")
                      .css("height", ""))),
                  o.rowEvenOdd.call(),
                  o.isLocked() && o.redraw(),
                  t(n.tableBody).css("visibility", ""),
                  t(n.wrap).addClass("m-datatable--loaded"),
                  o.sorting.call(),
                  o.scrollbar.call(),
                  o.spinnerCallback(!1);
              });
            ...
            t(window).scroll(function(t) {
              ...
              t(n.tableBody)
                ...
                .on("mouseenter", function() {
                  if (
                    ((o.hoverTimer = setTimeout(function() {
                      o.isScrolling = !1;
                    }, 200)),
                    !o.isScrolling)
                  ) {
          ...
          initHeight: function() {
            if (a.layout.height && a.layout.scroll) {
              ...
              e > 0 && (i -= e),
                o > 0 && (i -= o),
                t(n.tableBody).css("max-height", i),
                t(n.tableBody)
                  .find(".m-datatable__lock--scroll")
                  .css("height", i);
            }
          ...
          setupBaseDOM: function() {
            (n.initialDatatable = t(n).clone()),
              "TABLE" === t(n).prop("tagName")
                ? ((n.table = t(n)
                    .removeClass("m-datatable")
                    .addClass("m-datatable__table")),
                  0 === t(n.table).parents(".m-datatable").length &&
                    (n.table.wrap(
                      t("<div/>")
                        .addClass("m-datatable")
                        .addClass("m-datatable--" + a.layout.theme)
                    ),
                    (n.wrap = t(n.table).parent())))
                : ((n.wrap = t(n)
                    .addClass("m-datatable")
                    .addClass("m-datatable--" + a.layout.theme)),
                  (n.table = t("<table/>")
                    .addClass("m-datatable__table")
                    .appendTo(n))),
              void 0 !== a.layout.class && t(n.wrap).addClass(a.layout.class),
              t(n.table)
                .removeClass("m-datatable--destroyed")
                .css("display", "block"),
              void 0 === t(n).attr("id") &&
                (o.setOption("data.saveState", !1),
                t(n.table).attr("id", e.getUniqueID("m-datatable--"))),
              o.getOption("layout.minHeight") &&
                t(n.table).css("min-height", o.getOption("layout.minHeight")),
              o.getOption("layout.height") &&
                t(n.table).css("max-height", o.getOption("layout.height")),
              null === a.data.type &&
                t(n.table)
                  .css("width", "")
                  .css("display", ""),
              (n.tableHead = t(n.table).find("thead")),
              0 === t(n.tableHead).length &&
                (n.tableHead = t("<thead/>").prependTo(n.table)),
              (n.tableBody = t(n.table).find("tbody")),
              0 === t(n.tableBody).length &&
                (n.tableBody = t("<tbody/>").appendTo(n.table)),
              void 0 !== a.layout.footer &&
                a.layout.footer &&
                ((n.tableFoot = t(n.table).find("tfoot")),
                0 === t(n.tableFoot).length &&
                  (n.tableFoot = t("<tfoot/>").appendTo(n.table)));
          },
                    ...
                    .each(function(a, r) {
                      ...
                      if (void 0 !== s && void 0 !== s.template) {
                        ...
                        "string" == typeof s.template &&
                          (d = o.dataPlaceholder(s.template, l)),
              ...
              t(e)
                ...
                .each(function(e, a) {
                  0 === t(a).find("span").length &&
                    t(a).wrapInner(t("<span/>").css("width", o.offset));
                });
          },
          scrollbar: function() {
            var i = {
              ...
              init: function() {
                ...
                if (a.layout.scroll) {
                  ...
                  t(r).find(".m-datatable__row").length > 0 && t(r).length > 0
                    ? ((i.scrollHead = t(n.tableHead).find(
                        "> .m-datatable__lock--scroll > .m-datatable__row"
                      )),
                      (i.scrollFoot = t(n.tableFoot).find(
                        "> .m-datatable__lock--scroll > .m-datatable__row"
                      )),
                      (i.tableLocked = t(n.tableBody).find(
                        ".m-datatable__lock:not(.m-datatable__lock--scroll)"
                      )),
                      o.getOption("layout.customScrollbar") &&
                      10 != e.detectIE() &&
                      l > e.getBreakpoint("lg")
                        ? i.initCustomScrollbar(r[0])
                        : i.initDefaultScrollbar(r))
                    : t(n.tableBody).find(".m-datatable__row").length > 0 &&
                      ((i.scrollHead = t(n.tableHead).find(
                        "> .m-datatable__row"
                      )),
                      (i.scrollFoot = t(n.tableFoot).find(
                      ...
                      10 != e.detectIE() &&
                      l > e.getBreakpoint("lg")
                        ? i.initCustomScrollbar(n.tableBody)
                        : i.initDefaultScrollbar(n.tableBody));
              ...
              onScrolling: function(e) {
                var a = t(this).scrollLeft(),
                  n = t(this).scrollTop();
                t(i.scrollHead).css("left", -a),
                  t(i.scrollFoot).css("left", -a),
                  t(i.tableLocked).each(function(e, a) {
                    t(a).css("top", -n);
                  });
              },
          ...
          initScrollbar: function(a, o) {
            if ((t(n.tableBody).css("overflow", ""), e.hasClass(a, "ps")))
              t(a)
                .data("ps")
                .update();
            else {
          ...
          setHeadTitle: function(i) {
            ...
            void 0 === r &&
              ((r = document.createElement("tr")), i.appendChild(r)),
              t.each(l, function(a, o) {
                var i = s[a];
                if (
                  (void 0 === i &&
                  ...
                  void 0 !== o.title &&
                    ((i.innerHTML = o.title),
                    i.setAttribute("data-field", o.field),
                    e.addClass(i, o.class),
                    t(i).data(o)),
                  void 0 !== o.attr &&
                    t.each(o.attr, function(t, e) {
                      i.setAttribute(t, e);
                    }),
                  void 0 !== o.textAlign)
                ) {
                  var l =
                    void 0 !== n.textAlign[o.textAlign]
          ...
          dataRender: function(e) {
            ...
            var i = function() {
                ...
                0 === e.perpage && (e.perpage = a.data.pageSize || 10),
                  (e.total = n.dataSet.length);
              ...
              l = function(e) {
                var l = function(e, a) {
                  ...
                  o.localDataUpdate(),
                    (n.dataSet = t(n.dataSet).slice(i, l)),
                    o.insertData();
                };
            ...
            "local" === a.data.type ||
            (!1 === a.data.serverSorting && "sort" === e) ||
            (!1 === a.data.serverFiltering && "search" === e)
              ? l()
              : o.getData().done(l);
          },
          insertData: function() {
            ...
            var i = o.getDataSourceParam(),
              ...
              d = {};
            void 0 !== a.data.attr.rowProps &&
              a.data.attr.rowProps.length &&
              (d = a.data.attr.rowProps.slice(r, s));
            var c = document.createElement("tbody");
            c.style.visibility = "hidden";
            var m = a.columns.length;
            if (
              (t.each(n.dataSet, function(l, r) {
                ...
                for (var u = 0; u < m; u += 1) {
                  var p = a.columns[u],
                    f = [];
                  if (
                    (o.getObject("sort.field", i) === p.field &&
                      f.push("m-datatable__cell--sorted"),
                    void 0 !== p.textAlign)
                  ) {
                    var g =
                      void 0 !== n.textAlign[p.textAlign]
                        ? n.textAlign[p.textAlign]
                        : "";
                    f.push(g);
                  }
                  ...
                  e.addClass(h, f.join(" ")),
                    ...
                    (h.innerHTML = o.getObject(p.field, r)),
                    s.appendChild(h);
                }
                c.appendChild(s);
              }),
              ...
              e.addClass(u, "m-datatable--error"),
                (u.innerHTML = o.getOption("translate.records.noRecords")),
                c.appendChild(u),
                t(n.wrap).addClass("m-datatable--error m-datatable--loaded"),
                o.spinnerCallback(!1);
            }
            t(n.tableBody).replaceWith(c),
              (n.tableBody = c),
              o.setupDOM(n.table),
              o.setupCellField([n.tableBody]),
              o.setupTemplateCell(n.tableBody),
              o.layoutUpdate();
          },
          updateTableComponents: function() {
            (n.tableHead = t(n.table).children("thead")),
              (n.tableBody = t(n.table).children("tbody")),
              (n.tableFoot = t(n.table).children("tfoot"));
          },
          getData: function() {
            o.spinnerCallback(!0);
            var e = {
            ...
            if (
              ("local" === a.data.type && (e.url = a.data.source),
              "remote" === a.data.type)
            ) {
              (e.url = o.getOption("data.source.read.url")),
                "string" != typeof e.url &&
                  (e.url = o.getOption("data.source.read")),
                "string" != typeof e.url &&
                  (e.url = o.getOption("data.source")),
                (e.headers = o.getOption("data.source.read.headers")),
                (e.method = o.getOption("data.source.read.method") || "POST");
              var i = o.getDataSourceParam();
              o.getOption("data.serverPaging") || delete i.pagination,
                o.getOption("data.serverSorting") || delete i.sort,
                (e.data = t.extend(
                  !0,
                  e.data,
                  i,
                  o.getOption("data.source.read.params")
                ));
            }
            return t
              .ajax(e)
              .done(function(e, a, i) {
                (n.lastResponse = e),
                  (n.dataSet = n.originalDataSet = o.dataMapCallback(e)),
                  o.setAutoColumns(),
                  t(n).trigger("m-datatable--on-ajax-done", [n.dataSet]);
              })
              .fail(function(e, a, i) {
                t(n).trigger("m-datatable--on-ajax-fail", [e]),
                  t(n.tableBody).html(
                    t("<span/>")
            ...
            var l = {
              ...
              init: function(e) {
                (l.meta = e),
                  ...
                  (l.paginateEvent = o.getTablePrefix()),
                  (l.pager = t(n.table).siblings(".m-datatable__pager")),
                  t(l.pager).hasClass("m-datatable--paging-loaded") ||
                    (t(l.pager).remove(),
                    0 !== l.meta.pages &&
                      (o.setDataSourceParam("pagination", {
                        page: l.meta.page,
                        pages: l.meta.pages,
                      ...
                      t(n).trigger(l.paginateEvent, l.meta),
              ...
              populate: function() {
                ...
                t("<li/>")
                  ...
                  t.each(o.getOption("toolbar.layout"), function(e, a) {
              ...
              paste: function() {
                t.each(t.unique(o.getOption("toolbar.placement")), function(
                  e,
                  a
                ) {
                  "bottom" === a &&
          ...
          columnHide: function() {
            ...
            t.each(a.columns, function(a, i) {
              if (void 0 !== i.responsive) {
                var l = i.field,
                  r = t.grep(t(n.table).find(".m-datatable__cell"), function(
                    e,
                    a
                  ) {
                    return l === t(e).data("field");
                  });
                e.getBreakpoint(i.responsive.hidden) >= o
                  ? t(r).hide()
                  : t(r).show(),
                  e.getBreakpoint(i.responsive.visible) <= o
                    ? t(r).show()
                    : t(r).hide();
              }
            });
          ...
          setupSubDatatable: function() {
            ...
            if (
              "function" == typeof e &&
              !(t(n.table).find(".m-datatable__subtable").length > 0)
            ) {
              t(n.wrap).addClass("m-datatable--subtable"),
                (a.columns[0].subtable = !0);
              var i = function(i) {
                  i.preventDefault();
                    ...
                    ((r = t("<tr/>")
                      ...
                      .append(
                        t("<td/>")
                          ...
                          .attr("colspan", o.getTotalColumns())
                      )),
                    t(l).after(r),
                  ...
                  t(l).hasClass("m-datatable__row--subtable-expanded")
                    ? (t(c).addClass(
                      ...
                      t(n).trigger("m-datatable--on-collapse-subtable", [l]))
                    : (t(c).addClass(
                        o.getOption("layout.icons.rowDetail.expand")
                      ),
                      t(l).addClass("m-datatable__row--subtable-expanded"),
                      t(n).trigger("m-datatable--on-expand-subtable", [l])),
                    0 === t(s).find(".m-datatable").length &&
                      (t.map(n.dataSet, function(t, e) {
                        return (
                          d === t[a.columns[0].field] && ((i.data = t), !0)
                        );
                      }),
                      (i.detailCell = s),
                      (i.parentRow = l),
          ...
          dataMapCallback: function(t) {
            var e = t;
            return "function" == typeof o.getOption("data.source.read.map")
              ? o.getOption("data.source.read.map")(t)
          ...
          spinnerCallback: function(t) {
            if (t) {
              if (!o.isSpinning) {
                ...
                !0 === e.message &&
                  (e.message = o.getOption("translate.records.processing")),
                  (o.isSpinning = !0),
                  void 0 !== mApp && mApp.block(n, e);
              }
          ...
          autoHide: function() {
            ...
            var e = function(e) {
              ...
              if (t(i).hasClass("m-datatable__row-detail"))
                t(this)
                  .find("i")
                  .removeClass(o.getOption("layout.icons.rowDetail.expand"))
                  .addClass(o.getOption("layout.icons.rowDetail.collapse")),
                  t(i).remove();
              else {
                t(this)
                  .find("i")
                  .removeClass(o.getOption("layout.icons.rowDetail.collapse"))
                  .addClass(o.getOption("layout.icons.rowDetail.expand"));
                var l = t(n)
            ...
            t(n.tableBody)
              ...
              .each(function() {
                t(this).prepend(
                  ...
                  0 ===
                  t(n.tableHead).find(".m-datatable__toggle-detail").length
                    ? (t(n.tableHead)
                        .find(".m-datatable__row")
                        .first()
                        .prepend(
          ...
          hoverColumn: function() {
            t(n.tableBody).on("mouseenter", ".m-datatable__cell", function() {
              ...
              t(o.cells().nodes()).removeClass("m-datatable__cell--hover"),
                t(o.column(e).nodes()).addClass("m-datatable__cell--hover");
            });
          },
          setAutoColumns: function() {
            o.getOption("data.autoColumns") &&
              (t.each(n.dataSet[0], function(e, n) {
                0 ===
                  t.grep(a.columns, function(t, a) {
                    return e === t.field;
          ...
          stateGet: function(t, e) {
            if (
              ((t = o.getTablePrefix(t)), !1 !== o.getOption("data.saveState"))
            ) {
              var a = null;
              return null !=
                (a =
            ...
            var e = {
              ...
              sortClick: function(i) {
                ...
                if (
                  ...
                  o.spinnerCallback(!0);
                  var d = "desc";
                  o.getObject("field", l) === r && (d = o.getObject("sort", l)),
                    (l = {
                      field: r,
                      sort: (d = void 0 === d || "desc" === d ? "asc" : "desc")
                    }),
                    o.setDataSourceParam("sort", l),
                    e.setIcon(),
                    setTimeout(function() {
                      o.dataRender("sort"),
                        t(n).trigger("m-datatable--on-sort", l);
                    }, 300);
                }
              }
            };
          ...
          localDataUpdate: function() {
            ...
            if (
              (void 0 !== l && !0 !== o.getOption("data.serverSorting")
                ? "function" == typeof l.sortCallback
                  ? (n.dataSet = l.sortCallback(n.originalDataSet, i, l))
                  : (n.dataSet = o.sortCallback(n.originalDataSet, i, l))
                : (n.dataSet = n.originalDataSet),
              "object" == typeof e.query &&
                !o.getOption("data.serverFiltering"))
            ) {
              e.query = e.query || {};
              var r = function(t) {
                  for (var e in t)
              ...
              void 0 !== s &&
                "" !== s &&
                ((s = s.toLowerCase()),
                (n.dataSet = t.grep(n.dataSet, r)),
                delete e.query[o.getGeneralSearchKey()]),
                t.each(e.query, function(t, a) {
                  "" === a && delete e.query[t];
                }),
                (n.dataSet = o.filterArray(n.dataSet, e.query)),
                (n.dataSet = n.dataSet.filter(function() {
                  return !0;
                }));
            }
            return n.dataSet;
          ...
          resetScroll: function() {
            void 0 === a.detail &&
              ...
              t(n.table)
                .find(".m-datatable__lock")
                .css("top", 0),
              t(n.tableBody).scrollTop(0));
          },
          getColumnByField: function(e) {
            var n;
            if (void 0 !== e)
              return (
                t.each(a.columns, function(t, a) {
          ...
          rowEvenOdd: function() {
            t(n.tableBody)
              ...
              t(n.wrap).hasClass("m-datatable--subtable")
                ? t(n.tableBody)
                    .find(
          ...
          redraw: function() {
            return (
              o.adjustCellsWidth.call(),
              o.isLocked() &&
                (o.scrollbar(), o.resetScroll(), o.adjustCellsHeight.call()),
              o.adjustLockContainer.call(),
              o.initHeight.call(),
              n
            );
          },
          ...
          reload: function() {
            return (
              (function(t, e) {
                ...
                a.data.serverFiltering || o.localDataUpdate(),
                  o.dataRender(),
                  t(n).trigger("m-datatable--on-reloaded");
                  ...
                  if (e == t(i).text()) {
                    var l =
                      t(i)
                        ...
                        .index() + 1;
                    return (
                      (n.API.record = n.API.value = o.getOneRow(
                        n.tableBody,
                        l
                      )),
                      n
          ...
          getColumn: function(e) {
            return (
              o.setSelectedRecords(),
              (n.API.value = t(n.API.record).find('[data-field="' + e + '"]')),
              n
            );
          },
          destroy: function() {
            t(n)
              ...
              .remove();
            var e = t(n.initialDatatable)
              .addClass("m-datatable--destroyed")
              .show();
            return (
              t(n).replaceWith(e),
              t((n = e)).trigger("m-datatable--on-destroy"),
              (o.isInit = !1),
              (e = null)
            );
          },
          sort: function(e, a) {
            ...
            return (
              o.setDataSourceParam("sort", i),
              setTimeout(function() {
                o.dataRender("sort"),
                  t(n).trigger("m-datatable--on-sort", i),
                  t(n.tableHead)
                    .find(".m-datatable__cell > span > i")
                    .remove();
              }, 300),
          ...
          setSelectedRecords: function() {
            return (
              (n.API.record = t(n.tableBody).find(".m-datatable__row--active")),
              n
            );
          },
          getSelectedRecords: function() {
            return (
              o.setSelectedRecords(),
              (n.API.record = n.rows(".m-datatable__row--active").nodes()),
              n.API.record
            );
          },
            ...
            void 0 !== n && (n = t.makeArray(n)),
              (i = function() {
                ...
                "object" == typeof n &&
                  ...
                  o.setDataSourceQuery(i),
                  a.data.serverFiltering || o.localDataUpdate(),
                  o.dataRender("search");
              }),
              (l = o.getOption("search.delay")),
              clearTimeout(o.timer),
              (o.timer = setTimeout(i, l));
            var i, l;
          },
          setDataSourceParam: function(e, a) {
            (n.API.params = t.extend(
              ...
              n.API.params,
              o.stateGet(o.stateId)
            )),
              (n.API.params = o.extendObj(n.API.params, e, a)),
              o.stateKeep(o.stateId, n.API.params);
          },
          getDataSourceParam: function(e) {
            return (
              ...
              "string" == typeof e ? o.getObject(e, n.API.params) : n.API.params
            );
          },
          ...
          hideColumn: function(e) {
            ...
            var o = t.grep(t(n.table).find(".m-datatable__cell"), function(
              a,
              n
            ) {
          ...
          row: function(e) {
            return (
              o.rows(e), (o.nodeTr = o.recentNode = t(o.nodeTr).first()), n
            );
          },
          rows: function(e) {
            return (
              (o.nodeTr = o.recentNode = t(n.tableBody)
                .find(e)
          ...
          column: function(e) {
            return (
              (o.nodeCols = o.recentNode = t(n.tableBody).find(
          ...
          columns: function(e) {
            ...
            return (
              i.length > 0
                ? (o.nodeCols = o.recentNode = i)
                : (o.nodeCols = o.recentNode = t(a)
                    .find(e)
          ...
          cell: function(e) {
            return (
              o.cells(e), (o.nodeTd = o.recentNode = t(o.nodeTd).first()), n
            );
          },
          cells: function(e) {
          ...
          visible: function(e) {
            if (t(o.recentNode.length)) {
              ...
              if (o.recentNode === o.nodeCols) {
                ...
                if (o.isLocked()) {
                  var l = t(o.recentNode).closest(".m-datatable__lock--scroll")
                    .length;
                  l
                    ? (i += n.left.length + 1)
                    : t(o.recentNode).closest(".m-datatable__lock--right")
                        .length && (i += n.left.length + l + 1);
                }
              }
              e
                ? (o.recentNode === o.nodeCols &&
                    delete a.columns[i].responsive,
                  t(o.recentNode).show())
                : (o.recentNode === o.nodeCols &&
                    o.setOption("columns." + i + ".responsive", {
                      hidden: "xl"
                    }),
                  t(o.recentNode).hide()),
                o.redraw();
        ...
        if (
          ...
          if ("string" == typeof a) {
            var i = a;
            void 0 !== (n = t(this).data("mDatatable")) &&
              ((a = n.options),
              o[i].apply(this, Array.prototype.slice.call(arguments, 1)));
          } else
            n.data("mDatatable") ||
              ...
              (a = t.extend(!0, {}, t.fn.mDatatable.defaults, a)),
              (n.options = a),
              o.init.apply(this, [a]),
              t(n.wrap).data("mDatatable", n));
        else
          void 0 === (n = t(this).data("mDatatable")) &&
      ...
      for (var o = 0, i = e.length; o < i; o++) {
        ...
        mUtil.hasClass(l, "m-dropdown--disable-close") &&
          ...
          s && n !== s && !1 === s.contains(n) && !1 === n.contains(s)
            ? !1 === l.contains(n) && (r.isPersistent(), r.hide())
      ...
      (s = mUtil.get("body")),
        ...
        0 !== $("#m_aside_left_minimize_toggle").length &&
          ...
          o.on("beforeToggle", function(t) {
            ...
            !1 === mUtil.hasClass(e, "m-aside-left--minimize") &&
              mUtil.hasClass(e, "m-aside-left--minimize-hover") &&
              mUtil.removeClass(e, "m-aside-left--minimize-hover");
          })),
        l(),
